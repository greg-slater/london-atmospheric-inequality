...
date: "January 3, 2019"
bibliography: assessment_3_2.bib
output:
  word_document:
...
knitr::include_graphics('output_pics/shiny/title_bar.png')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", paged.print=FALSE, fig.cap="figure 1"}
knitr::include_graphics('output_pics/process_diagram/assessment_3_process_diagram_small.png')
```
...
[Link to application](https://casa-gis-mod.shinyapps.io/shiny_app/)
